...
from .analyst import analyze_run, replay_analyze
...
def build_parser() -> argparse.ArgumentParser:
    ...
    replay_parser = subparsers.add_parser("replay-analyze", help="Replay analysis for archived videos or queued retries.")
    replay_parser.add_argument("--archive-path", action="append", default=None, help="Archive JSON path to analyze.")
    replay_parser.add_argument("--archive-dir", default=None, help="Analyze all archive JSON files inside a directory.")
    replay_parser.add_argument("--retry-manifest", default=None, help="Process due entries from a retry manifest.")
    replay_parser.add_argument(
        "--analysis-result-path",
        required=True,
        help="Path to write the JSON replay analysis result.",
    )
    replay_parser.add_argument("--data-dir", default=None, help="Override the analysis data directory.")
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        if args.command == "replay-analyze":
            payload = replay_analyze(
